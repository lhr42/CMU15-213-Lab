...
0000000000400ee0 <phase_1>:
  ...
  400eee:	85 c0                	test   %eax,%eax  #strings equal则返回0(eax为0)
...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)  #if(第一个参数 == 0x1)
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400f1a:	01 c0                	add    %eax,%eax
  400f1c:	39 03                	cmp    %eax,(%rbx)  #if(第二个参数 == 2 * 第一个参数)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx  #指向第三个参数
  400f29:	48 39 eb             	cmp    %rbp,%rbx  #if(%rbx != %rsp + 0x10)
...
0000000000400f43 <phase_3>:
  ...
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) #if(第一个数 > 7) explode_bomb;
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax #mov第一个数到%eax
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax #if(第二个数 == %eax) ret;//eax取决于400f75处 jmp *0x402470(,%rax,8)到了哪
...
0000000000400fce <func4>:
  ...
  400fe2:	39 f9                	cmp    %edi,%ecx  #if(%ecx <= 第一个数)
  ...
  400ff7:	39 f9                	cmp    %edi,%ecx  #if(%ecx >= 第一个数) return 0;
...
000000000040100c <phase_4>:
  ...
  401033:	76 05                	jbe    40103a <phase_4+0x2e>  #第一个数需要<=0xe
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi
  401048:	e8 81 ff ff ff       	call   400fce <func4> #参数%edi:M(%rsp+8) %esi:0 %edx:0xe %rcx:%rsp+0xc
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>  #func返回值需要==0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) #第二个数需要==0
...
0000000000401062 <phase_5>:
  ...
  40107a:	e8 9c 02 00 00       	call   40131b <string_length> #len should be 6
  40107f:	83 f8 06             	cmp    $0x6,%eax
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx # %ecx = s[i](i from 0 to 5)
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx  # %edx = s[i] & 0xf
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
  4010a4:	48 83 c0 01          	add    $0x1,%rax  # i++
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax  # if(i != 6)  goto loop;
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal> #rsp + 10和0x40245e处的字符串"flyers"需相等
  ...
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax  #检测金丝雀值, 防止缓冲区溢出攻击
  4010e5:	00 00 
...
00000000004010f4 <phase_6>:
  ...
  401103:	48 89 e6             	mov    %rsp,%rsi  #读6个数到rsp + [0, 4, 8, c, 0x10, 14]上
  ...
  40111e:	83 f8 05             	cmp    $0x5,%eax  #每个数数-1 <= 5
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d #for r12d from 0 to 5
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax #依次取后面的数
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) #都不能等于本轮循环的第一个数
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx  #i++
  401148:	83 fb 05             	cmp    $0x5,%ebx  #if(i <= 5) goto loop;
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13  #从下一个数开始, 继续
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx  #%rbx:s1;
  40133f:	48 89 f5             	mov    %rsi,%rbp  #%rbp:s2;
  401342:	e8 d4 ff ff ff       	call   40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi  #get string_length(s2)
  40134d:	e8 c9 ff ff ff       	call   40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d #if(string_length(s2) != string_length(s1)) return 1;
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>
  40135c:	0f b6 03             	movzbl (%rbx),%eax  #get s1[0];
  40135f:	84 c0                	test   %al,%al  #if(s1[0] == '\0')  return 0;//equal;
  401361:	74 25                	je     401388 <strings_not_equal+0x50>
  401363:	3a 45 00             	cmp    0x0(%rbp),%al  #if(s2[0] == s1[0]) goon;
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>
  40136a:	3a 45 00             	cmp    0x0(%rbp),%al  #if(s2[i] != s1[i]) return 1;
  40136d:	0f 1f 00             	nopl   (%rax)
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>
  401372:	48 83 c3 01          	add    $0x1,%rbx  #s1++;
  401376:	48 83 c5 01          	add    $0x1,%rbp  #s2++;
  40137a:	0f b6 03             	movzbl (%rbx),%eax  #mov *s1;
  40137d:	84 c0                	test   %al,%al  #while(*s1 != '\0') goto loop;
  ...
  40139b:	89 d0                	mov    %edx,%eax  #return 1;//not equal
  40139d:	5b                   	pop    %rbx
  40139e:	5d                   	pop    %rbp
...
000000000040145c <read_six_numbers>:
  ...
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi #sscanf的format参数
